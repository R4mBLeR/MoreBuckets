...
public class ModItems {
    ...
    public static final RegistryObject<Item> WOODEN_BUCKET = ITEMS.register("wooden_bucket", () -> new UniversalBucketItem(
            new UniversalBucketItem.Properties().tab(ModItemTabs.MORE_BUCKETS_MOD_TAB).durability(6).upperCrackingTemperature(1000)
    ));
    ...
    public static final RegistryObject<Item> GOLD_BUCKET = ITEMS.register("gold_bucket", () -> new UniversalBucketItem(
            new UniversalBucketItem.Properties().tab(ModItemTabs.MORE_BUCKETS_MOD_TAB).durability(0)
    ));
    ...
    public static final RegistryObject<Item> UNFIRED_CLAY_BUCKET = ITEMS.register("unfired_clay_bucket", () -> new UniversalBucketItem(
            new UniversalBucketItem.Properties().tab(ModItemTabs.MORE_BUCKETS_MOD_TAB).durability(2).upperCrackingTemperature(1000).lowerCrackingTemperature(0).disableEntityObtaining().disableBlockObtaining().disableMilking()
    ));
